 ...
 */
     ...
     */ 
         ...
         * 
         *
         * @see \Kyslik\LaravelFilterable\FilterableServiceProvider::registerMacros()
         * @param \Kyslik\LaravelFilterable\FilterContract|null $filter
         * @static 
         */ 
        public static function hasAnyFilter($filter = null)
        {
                        return \Illuminate\Http\Request::hasAnyFilter($filter);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function fullUrlWithNiceQuery($query)
        {
                        return \Illuminate\Http\Request::fullUrlWithNiceQuery($query);
        }
