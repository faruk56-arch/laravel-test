...
return [
    ...
    */
    ...
    'options' => [
        ...
        'repository'      => 'git@gitlab.com:wigo-media/classic-parts-finder.git',
        //        'upload_vendors' => true,
        'bin/php' => '/opt/php7.3/bin/php',
        'bin/composer'    => '/opt/php7.3/bin/php /home/clients/9985aa5e4e594e4e546b50127056b081/composer.phar',
        'composer_action' => 'install --no-dev',
        'upload_options'  => [
            'options' => [
                '--exclude=.git',
    ...
    */
    ...
    'hosts' => [
        'classic-parts-finder.com' => [
            'deploy_path' => '/home/clients/9985aa5e4e594e4e546b50127056b081/classic-parts-finder',
            'user'        => 'dz8uz_admin',
        ],
    ],
